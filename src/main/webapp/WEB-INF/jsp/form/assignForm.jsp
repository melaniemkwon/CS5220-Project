		...
		<tbody>
			<c:forEach items="${users}" var="user">
				<tr>
					...
					<td class="col-md-1"><a class="btn" href="view.html?id=${user.id}" data-toggle="tooltip" title="View User"><i class="glyphicon glyphicon-eye-open"></i></a> <a class="btn"
						...
						data-toggle="tooltip" title="Delete User"><i class="glyphicon glyphicon-trash"></i></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
